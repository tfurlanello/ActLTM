...
s.layers = struct(...
  ...
  'block', {[]}) ;
s.meta = obj.meta ;
s.inputsNames       =   obj.inputsNames;
s.predictionsNames  =   obj.predictionsNames;
s.outputsNames      =   obj.outputsNames;
s.updatelists       =   obj.updatelists;
s.synLayers         =   obj.synLayers;
% for auxiliary usage
s.layersNames       =   obj.layersNames;
s.mapsInputs        =   obj.mapsInputs;
s.mapsOutputs       =   obj.mapsOutputs;
s.lf_layersNames    =   obj.lf_layersNames;
s.lf_mapsInputs     =   obj.lf_mapsInputs;
s.lf_mapsOutputs    =   obj.lf_mapsOutputs;
