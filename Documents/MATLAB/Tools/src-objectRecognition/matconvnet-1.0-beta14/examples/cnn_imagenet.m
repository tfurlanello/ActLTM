...
% opts.dataDir = fullfile('data','ILSVRC2010') ;
opts.dataDir = '/home2/u/jiaping/imageNet2010';
...
opts.expDir = fullfile(opts.dataDir, sprintf('imagenet10-%s-%s', ...
                                       sfx, opts.networkType)) ;

% opts.expDir = fullfile('data', sprintf('imagenet10-%s-%s', ...
%                                        sfx, opts.networkType)) ;
[opts, varargin] = vl_argparse(opts, varargin) ;
...
%   opts.train.learningRate = logspace(-2, -4, 60) ; % original setting
