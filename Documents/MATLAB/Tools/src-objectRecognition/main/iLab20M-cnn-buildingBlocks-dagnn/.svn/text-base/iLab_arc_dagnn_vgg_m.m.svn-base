function net = iLab_arc_dagnn_vgg_m(nclasses, args, labelgraph)   
% inputs:
%       nclasses       - # of classes
%       labelgraph     - whether use a structured loss function on
%                        output label space
    ...
    outputsNames     = {};
    predictionsNames = {};
    % build a vgg-m architecture
    [net, layerNames, mapInputs, mapOutputs] = ...
                        iLab_dagnn_vgg_m(nclasses, opts); 
