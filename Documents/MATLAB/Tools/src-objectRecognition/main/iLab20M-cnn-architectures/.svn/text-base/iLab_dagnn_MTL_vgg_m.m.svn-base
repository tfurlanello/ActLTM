function varargout = iLab_dagnn_MTL_vgg_m( args)
%% note:
...
%     nameActivation  = 'relu1';
    nameConv       = sprintf('%s%d', namesStandard.('conv'),  1);
...
%     nameActivation  = 'relu2'; 
    nameConv       = sprintf('%s%d', namesStandard.('conv'),  2);
...
%     nameActivation  = 'relu3';
    nameConv       = sprintf('%s%d', namesStandard.('conv'),  3);
...
%     nameActivation  = 'relu4';   
    nameConv       = sprintf('%s%d', namesStandard.('conv'),  4);
...
%     nameActivation  = 'relu5';    
    nameConv        = sprintf('%s%d', namesStandard.('conv'),  5);
...
%     nameDropout     = 'dropout6';
    nameConv        = sprintf('%s%d', namesStandard.('fc'),     1);
...
%     nameDropout     = 'dropout7';
    nameConv        = sprintf('%s%d', namesStandard.('fc'),     2);
