...
function [net, netLinear] = iLab_arc_dagnn_multiLevelInjection_conv345(nclasses_obj, ...
...
%%   add an auxiliary deep label network to aid object recognition
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
	fc1size = 1024;
    fc2size = 1024;   
    %% inject into conv5
    ...
    % prediction layer
    nameLayer   =   iLab_dagnn_getNewLayerName(net, 'conv5Prediction_env');
    inputs      =   outputs;
    outputs     =   iLab_dagnn_getNewVarName(net, 'prediction_env');
