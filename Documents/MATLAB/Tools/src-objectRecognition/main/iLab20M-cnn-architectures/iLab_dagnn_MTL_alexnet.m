function varargout = iLab_dagnn_MTL_alexnet(args)  
%% note:
...
%     nameActivation  = 'relu1';    
    nameLayer       = sprintf('%s%d', namesStandard.('conv'),  1);
    nameBnorm       = sprintf('%s%d', namesStandard.('bnorm'), 1);
    nameNorm        = sprintf('%s%d', namesStandard.('norm'),  1);
    nameActivation  = sprintf('%s%d', namesStandard.('relu'),  1);
    namePool        = sprintf('%s%d', namesStandard.('pool'),  1);
    nameInput       = sprintf('%s%d', namesStandard.('input'), 1);    
...
%     nameActivation  = 'relu2';    
    nameLayer       = sprintf('%s%d', namesStandard.('conv'),  2);
    nameBnorm       = sprintf('%s%d', namesStandard.('bnorm'), 2);
    nameNorm        = sprintf('%s%d', namesStandard.('norm'),  2);
    nameActivation  = sprintf('%s%d', namesStandard.('relu'),  2);
    namePool        = sprintf('%s%d', namesStandard.('pool'),  2);    
...
%     nameActivation   = 'relu3';    
    nameLayer       = sprintf('%s%d', namesStandard.('conv'),  3);
    nameBnorm       = sprintf('%s%d', namesStandard.('bnorm'), 3);    
    nameActivation  = sprintf('%s%d', namesStandard.('relu'),  3);        
...
%     nameActivation  = 'relu4';
    nameLayer       = sprintf('%s%d', namesStandard.('conv'),  4);
    nameBnorm       = sprintf('%s%d', namesStandard.('bnorm'), 4);
    nameActivation  = sprintf('%s%d', namesStandard.('relu'),  4);
...
%     nameActivation  = 'relu5';    
    nameLayer       = sprintf('%s%d', namesStandard.('conv'),  5);
    nameBnorm       = sprintf('%s%d', namesStandard.('bnorm'), 5);
    nameActivation  = sprintf('%s%d', namesStandard.('relu'),  5);
    namePool        = sprintf('%s%d', namesStandard.('pool'),  5);    
...
%     nameDropout     = 'dropout6';    
    nameLayer       = sprintf('%s%d', namesStandard.('fc'),     1);
    nameBnorm       = sprintf('%s%d', namesStandard.('bnorm'),  6);
    nameActivation  = sprintf('%s%d', namesStandard.('relu'),   6);
    nameDropout     = sprintf('%s%d', namesStandard.('dropout'),6);
    ...
    LayerInputs = cat(2, LayerInputs, inputs);
	net = iLab_dagnn_addlayer_conv(net, nameLayer, inputs, outputs, ...
                {'size', [6 6 256 1024], 'stride', 1, 'pad', 0, ...
                'learningRate', opts.conv.learningRate, ...
                'weightDecay',  opts.conv.weightDecay, ...
                'weightInitMethod', opts.conv.weightInitMethod, ...
                'scale', opts.conv.scale});
...
%     nameDropout     = 'dropout7';    
    nameLayer       = sprintf('%s%d', namesStandard.('fc'),     2);
    nameBnorm       = sprintf('%s%d', namesStandard.('bnorm'),  7);
    nameActivation  = sprintf('%s%d', namesStandard.('relu'),   7);
    nameDropout     = sprintf('%s%d', namesStandard.('dropout'),7);    
    ...
    LayerInputs = cat(2, LayerInputs, inputs);
    net = iLab_dagnn_addlayer_conv(net, nameLayer, inputs, outputs, ...
                {'size', [1 1 1024 1024], 'stride', 1, 'pad', 0, ...
                'learningRate', opts.conv.learningRate, ...
                'weightDecay',  opts.conv.weightDecay, ...
                'weightInitMethod', opts.conv.weightInitMethod, ...
                'scale', opts.conv.scale});
...
%     LayerInputs = cat(2, LayerInputs, inputs);
%     net = iLab_dagnn_addlayer_conv(net, nameLayer, inputs, outputs, ...
%                 {'size', [1 1 1024  nclasses], 'stride', 1, 'pad', 0, ...
%                 'learningRate', opts.conv.learningRate, ...
%                 'weightDecay',  opts.conv.weightDecay, ...
%                 'weightInitMethod', opts.conv.weightInitMethod, ...
%                 'scale', opts.conv.scale});
