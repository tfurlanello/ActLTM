...
%                                                             label mapping
% -------------------------------------------------------------------------
load(fullfile(opts.dataDir, 'metadata-disentangling', ['mappings-f' num2str(opts.nf) '.mat']));
objs          =  mapObject.keys;
...
% fclose(fid);
[a,b,c,d,e,f] = textread(fullfile(opts.dataDir, 'metadata-disentangling', ['train-f' num2str(opts.nf) '.txt']), ...
                                        '%s %s %s %s %s %s\n');
b_num = str2double(b);
d_num = str2double(d);
...
% fclose(fid);
[a,b,c,d,e,f] = textread(fullfile(opts.dataDir, 'metadata-disentangling', ['test-f' num2str(opts.nf) '.txt']), ...
                                        '%s %s %s %s %s %s\n');
b_num = str2double(b);
d_num = str2double(d);
