...
arc_types = {'alexnet-dagnn-2streams-disentangling', ...
             'iLab_arc_de_dagnn_2streams_woL2', ...
              'iLab_arc_de_dagnn_2streams_wL2', ...
              'iLab_arc_de_dagnn_2streams_alexnet'};
          
arc_currents     = [2 3 3 4 3];          
bmemory          = true; 
balancingFactors = {[1 1], [0.3 1 1], [0.1 1 1], 1, [0.05 1 1]};
...
%     saveDir = par_imdb.dataDir;
    saveDir = '/lab/igpu3/u/jiaping/iLab20M-objRec/CNN-results/disentangling-ECCV';
