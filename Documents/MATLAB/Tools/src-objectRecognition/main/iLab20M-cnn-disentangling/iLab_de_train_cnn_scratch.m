...
arc_types = {'alexnet-dagnn-2streams-disentangling', ...
             'iLab_arc_de_dagnn_2streams_woL2_rndw', ...
              'iLab_arc_de_dagnn_2streams_wL2_rndw'};
          
arc_currents = [2 3 3];          
bmemory = true; 
balancingFactors = {[1 1], [0.1 1 1], [0.01 1 1]};
...
switch param.modelType
    ...
    case 'iLab_arc_de_dagnn_2streams_woL2_rndw'
        
        net = iLab_arc_de_dagnn_2streams_woL2_rndw(nclasses_obj, nclasses_transformation,...
...
%                       net.outputsNames{3}, balancingFactors(3), net.outputsNames{4},balancingFactors(4)};
    ...
    case 'iLab_arc_de_dagnn_2streams_wL2_rndw'
        
        net = iLab_arc_de_dagnn_2streams_wL2_rndw(nclasses_obj, nclasses_transformation,...
                                        bshare, bshare_lf, arc, struct('isstructured', false, 'labelgraph', [])); 
