function net = iLab_arc_de_dagnn_2streams_wL2_rndw( ...
                            nclasses, ntransformations, bshare_s, bshare_lf,...
...
%% additional notes:
% what is the difference between this architecture and the architecture
% built by the script 'iLab_arc_dagnn_2streams_disentangling2.m'
% the former has only one 'l2-loss' layer, which the latter has two
% 'l2-loss' layers
% to be specifically, in this script, the identity representation layer of
% the left image is always used the 'ground-truth' representation of the
% image pairs, and it is used to regularize the 'identity representation'
% of the right image
