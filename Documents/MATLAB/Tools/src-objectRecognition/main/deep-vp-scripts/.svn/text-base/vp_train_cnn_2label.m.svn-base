...
%   make sure: parameters are consistent
    ...
    param.modelType         = 'alexnet-dagnn-multiLevelInjection-fc2' ;
...
%                                                              dataset info
% -------------------------------------------------------------------------
    par_imdb.dataDir = '/home2/u/kai/deep_vp/google_dataset3';
    par_imdb.lite = false ;
...
if exist(par_imdb.imdbFile, 'file')
  ...
  imdb = vp_cnn_setupdata_2label('dataDir', par_imdb.dataDir, 'lite', par_imdb.lite) ;
  mkdir(param.expDir) ;
