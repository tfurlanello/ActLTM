function imo = iLab_getImageBatch(images, opts)
%  Load, preprocess, and pack images for CNN evaluation

% several notices for iLab20M dataset:
% 1. image shouldn't be flipped, either horizontally or vertically
...
opts = iLab_nn_validateGetImageBatchParam(opts);
...
for i=1:numel(images)
 ...
 %imt = iLab_imrescale(imt, [opts.imageSize(1) opts.imageSize(2)]);
