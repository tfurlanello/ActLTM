function iLab_cnnClassification_catcam_test(varargin)
...
opts.expDir = fullfile(opts.dataDir, sprintf('iLab20M-%s-%s-cam', ...
...
if ~opts.batchNormalization
  opts.train.learningRate = logspace(-2, -4, 20) ;
else
...
im = cnn_imagenet_get_batch(images, opts, ...
                            'prefetch', nargout == 0) ;
labels = imdb.images.label(2,batch) ;
...
if nargout > 0
  ...
  inputs = {'input', im, 'label', imdb.images.label(2,batch)} ;
end
