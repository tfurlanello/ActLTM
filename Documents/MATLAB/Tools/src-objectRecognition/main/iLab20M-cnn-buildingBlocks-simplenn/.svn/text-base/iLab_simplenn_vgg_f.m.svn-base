function net = iLab_simplenn_vgg_f(varargin)
...
% vgg-f
    ...
    net.layers = {} ;
    net = iLab_simplenn_addblock(net, opts, '1', 11, 11, 3, 64, 4, 0) ;
    ...
    net = iLab_simplenn_addblock(net, opts, '2', 5, 5, 64, 256, 1, 2) ;
    ...
    net = iLab_simplenn_addblock(net, opts, '3', 3, 3, 256, 256, 1, 1) ;
    net = iLab_simplenn_addblock(net, opts, '4', 3, 3, 256, 256, 1, 1) ;
    net = iLab_simplenn_addblock(net, opts, '5', 3, 3, 256, 256, 1, 1) ;
